            ...
            <div class="container store__container">
                <div class="store__menu">
                    ...
                    <div class="store__wrapper games">
                        ...
                        $gameSelect = "SELECT * FROM `product` ORDER BY game_name";
    ...
    <footer class="footer">
        <div class="container footer__container">
            <p class="footer__text">
                © 2022 Ivanov Games Corporation. Все права защищены. Все торговые марки являются собственностью соответствующих владельцев в РФ и других странах.
