...
if (isset($_GET['gameid'])) {
    $gameid = $_GET['gameid'];
    $gameInsert = "INSERT INTO `bucket` (`id_user`, `id_game`) VALUES ('$user', '$gameid')";
        ...
        <section class="main__section cart">
            <div class="container cart__container">
                ...
                <div class="cart__game-wrapper game">
                    ...
                    INNER JOIN product on bucket.id_game = product.id
                    ...
                    <ul class="game__list">
                        ...
                        foreach ($cartSelectResult as $cartRow) {
                            ...
                            echo "<a href='buy.php?idbuygame=" . $cartRow['id_game'] . "' class='price__delete'>Купить</a>";
                            echo "<a href='cart.php?delete=" . $cartRow['id_bucket'] . "' class='price__delete'>Удалить</a>";
                            echo "</div>";
                        ...
                        if (isset($_GET['delete'])) {
                            ...
                            $deleteGame = "DELETE FROM `bucket` WHERE id_bucket = '$gamedeleteId'";
                ...
                <div class="game__down down">
                    ...
                    <a href="cart.php?deleteall=1" class="down__continue">Удалить все товары</a>
                    <?php
                    if (isset($_GET['deleteall'])) {
                        $deleteAllGames = "DELETE FROM `bucket` WHERE id_user = '$user'";
